...
def parse_args():
    ...
    parser.add_argument('--filepath', dest='filepath', default='C:/trips/test/valid/dog2.jpg') # use a deafault filepath to a primrose image 
    parser.add_argument('--category_names', dest='category_names', default='C:/Users/CatYura/source/repos/FleatMarket/FleatMarket/wwwroot/python/cat_to_name.json')
...
def predict(image_path, model, topk=3, gpu='gpu'):
    ...
    top_classes = probability.topk(topk)[1][0].cpu().numpy()
